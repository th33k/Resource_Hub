...
function Slidebar() {
    ...
    return (
        <div className='slidebar'>
            <ul>
                <li>
                    <Link to={'AdminUser-DashboardUser'}>
                ...
                <li>
                    ...
                    <div className={`submenuWrapper ${activeTab === 2 && isToggleSubmenu === true ? 'collapsed show' : 'collapsed'}`}> 
                        <ul className="submenu">
                            <li><Link to="AdminUser-AssetRequest">User_Requests</Link></li>
                            <li><Link to="AdminUser-DueAssets">User Due Assets</Link></li>
                        </ul>
                    </div>
                </li>
                <li>
                <Button 
                        ...
                        <Link to="AdminUser-maintenanceHome">Maintenance</Link>
                        <span className='arrow'><IoIosArrowForward /></span>
                    </Button>
                    <div className={`submenuWrapper ${activeTab === 3 && isToggleSubmenu === true ? 'collapsed show' : 'collapsed'}`}> 
                        <ul className="submenu">
                        <li><Link to="AdminUser-maintenanceDetails">All Maintenances</Link></li>
                ...
                <li>
                    ...
                    <div className={`submenuWrapper ${activeTab === 4 && isToggleSubmenu === true ? 'collapsed show' : 'collapsed'}`}> 
                        <ul className="submenu">
                            <li><Link to="AdminUserUser-users">User list</Link></li>
                        </ul>
                    </div>
                </li>
            </ul>
