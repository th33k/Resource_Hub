...
export const API_ENDPOINTS = {
    ...
    ASSET_REQUEST_DETAILS_BY_USER: (userId) => `${BASE_URLS.assetRequest}/details/${userId}`,
    ASSET_REQUEST_DUE_ASSETS: `${BASE_URLS.assetRequest}/dueassets`,
    ASSET_REQUEST_DUE_ASSETS_BY_USER: (userId) => `${BASE_URLS.assetRequest}/dueassets/${userId}`,

    // Calendar & Meal Events
    CALENDAR_MEAL_EVENTS: `${BASE_URLS.calendar}/mealevents`,
    CALENDAR_MEAL_EVENTS_BY_USER: (userId) => `${BASE_URLS.calendar}/mealevents/${userId}`,
    CALENDAR_MEAL_EVENTS_ADD: `${BASE_URLS.calendar}/mealevents/add`,
    CALENDAR_MEAL_EVENTS_DELETE: (eventId) => `${BASE_URLS.calendar}/mealevents/${eventId}`,
    ...
    SETTINGS_UPDATE: (endpoint, userId) => `${BASE_URLS.settings}/${endpoint}/${userId}`,
    SETTINGS_PASSWORD_UPDATE: (userId) => `${BASE_URLS.settings}/password/${userId}`,
    SETTINGS_PROFILE_UPDATE: (userId) => `${BASE_URLS.settings}/profile/${userId}`,
    ...
    // User Dashboard
    USER_DASHBOARD_STATS: (userId) => `${BASE_URLS.dashboardUser}/stats/${userId}`,
    USER_DASHBOARD_ACTIVITIES: (userId) => `${BASE_URLS.dashboardUser}/activities/${userId}`,
};
